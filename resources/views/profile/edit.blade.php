...
<form action="{{ url('profile/update/'.$profile->user_id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row form-row">
            ...
            <div class="col-12 col-sm-6 mt-3">
                <div class="form-group">
                    <label for="country">City</label><span style="color: red !important; display: inline; float: none;">*</span>      
                    <input type="text" name="city" value="{{ old('city',$profile->city) }}" class="form-control @error('city')is-invalid @enderror">
                    @error('city')
                    <p class="invalid-feedback">{{$message}}</p>
                @enderror
                </div>
